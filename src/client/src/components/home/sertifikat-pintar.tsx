...
const SertifikatPintar: FC = () => {
  return (
    <section className="bg-gradient-to-br from-[#f7b32b] to-[#f9c55d] px-4 py-12 sm:px-6 sm:py-24">
      <div className="mx-auto w-[90%] flex flex-col items-center justify-between gap-8 lg:flex-row lg:gap-12">
